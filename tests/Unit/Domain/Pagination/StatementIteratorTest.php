...
final class StatementIteratorTest extends TestCase
{
    ...
    {
        $item1 = (object) ['id' => 1, 'name' => 'Transaction 1'];
        $item2 = (object) ['id' => 2, 'name' => 'Transaction 2'];
        $items = [$item1, $item2];
        ...
        /** @var array<object{id: int, name: string}> $result */
        $result = [];
        /**
         * @var int $key
         * @var object{id: int, name: string} $item
         */
        foreach ($iterator as $key => $item) {
            $result[] = $item;
        }
    ...
    public function testValidReturnsFalseBeforeRewind(): void
    {
        /** @var callable(Page): PagedResult<int> $fetcher */
        $fetcher = fn(Page $page): PagedResult => PagedResult::of([1, 2, 3], 10, $page);
    ...
    public function testNextBeforeRewindDoesNotCrash(): void
    {
        /** @var callable(Page): PagedResult<int> $fetcher */
        $fetcher = fn(Page $page): PagedResult => PagedResult::of([1, 2, 3], 10, $page);
